...
1. **Bronze Layer**: Stores raw data as-is from the source systems. Data is ingested from CSV Files into SQL Server Database. You can veiw the SQL scripts [here](/scripts/bronze).
2. **Silver Layer**: This layer includes data cleansing, standardization, and normalization processes to prepare data for analysis. You can veiw the SQL scripts [here](/scripts/silver).
